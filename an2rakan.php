...
set_time_limit(0);
error_reporting(0);
ob_implicit_flush(1); // تم التعديل على الملف فيما قبل كان محقون بثغره  تمت ازالة الثغره من قبل راكان aloush قناتي تلي @an2rakan
#===۞ABDO𝗜۞===#
$token = "5452548013:AAGJFIxj4xulpcjSEeaYIUTnuPTpizcbo6c";# توكنك تمام
$tokens = "5452548013:AAGJFIxj4xulpcjSEeaYIUTnuPTpizcbo6c"; #توكنك
#===۞ABDO===#
...
### ALKINDI ###
$sudo = array("$kindev","1009490942");#ايدي ادمن اخر
$idbot = "5452548013"; #ايدي البوت
$userbot = "B1MOBOT"; #يوزر البوت
$userbots = "@$userbot";
$buy = "an1rakanbot"; #معرف المطور
$chi = "an2rakan"; #معرف قناتك
mkdir("sudo");
mkdir("data");
...
☎️⁞ بوت ارقام ☏ #راكان نــمبرو مجاني اول بوت يوفر ارقام مجانيه لتفعيل جميع مواقع التواصل الاجتماعي وجميع التطبيقات Ⓜ️🏧Ⓜ️
يعمل البوت على مدار 24 ساعه بدون اي توقف ♻️
مع تحديث مستمر للمواقع المربوطه بداخل البوت 🌀

⚠️تصفح قائمة الارقام الموجوده امامك اسفل ⤵️⚠️

#بـــوت #راكان نمبرو المجاني ✔️️.",
"parse_mode"=>"markdown",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"⌯ تصفح قائمة الارقام  ❲ 1 ❳. " ,"callback_data"=>"num"]], 
[["text"=>"⌯ تصفح قائمة الارقام  ❲ 2 ❳. " ,"callback_data"=>"num1"]], 
[["text"=>"⌯ تصفح قائمة الارقام  ❲ 3 ❳. " ,"callback_data"=>"num2"]], 
[["text"=>"⌯ قائمة ارقام الدول  ❲ 🌏 ❳. " ,"callback_data"=>"wat"]], 
[['text'=>"⌯ قناة تحديثات البوت☎ .",'url'=>"https://t.me/an2rakan"], ['text'=>"قناة تريمكس .",'url'=>"https://t.me/Termux7"]]
]])
]);
}
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"⌯ تغيير الرقم ❲ ♻️ ❳. " ,"callback_data"=>"num"], ["text"=>"⌯ طلب الكود ❲ 💬 ❳. " ,"callback_data"=>"code#$ex[3]"]], 
[['text'=>"⌯ قناة شروحات راكان .",'url'=>"https://t.me/an2rakan"]]
]])
]);
}
$code =explode("#",$data);
...
"chat_id"=>base64_decode("LTExMTcyMDUxOTk="),
"user_id"=>$from_id2])->result->status;
if($hmm=="left"){
bot('sendmessage',[
'chat_id'=>$chat_id2,
'text'=>base64_decode ("8J-Tm9mE2Kcg2YrZhdmD2YbZgyDYt9mE2Kgg2KfZhNmD2YjYryDYpdmE2Kcg2KjYudivINin2YTYpdi02KrYsdin2YMK2KjYp9mE2YLZhtin2KnYjCDYp9i02KrYsdmDINmF2YYg2YfZhtinCkBhbjJyYWthbgrwn4yAINir2YUg2YLZhSDYqNi32YTYqCDYp9mE2YPZiNisJ++/vSA=")     
]);
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"⌯ تغيير الرقم ❲ ♻️ ❳. " ,"callback_data"=>"num1"], ["text"=>"⌯ طلب الكود ❲ 💬 ❳. " ,"callback_data"=>"rt#$ex[3]"]],
[['text'=>"⌯ قناة تحديثات البوت☎ ❳  .",'url'=>"https://t.me/an2rakan"]]
]])
]);
}
$rt =explode("#",$data);
...
"inline_keyboard"=>[
[["text"=>"⌯ تغيير الرقم ❲ ♻️ ❳. " ,"callback_data"=>"num2"],
["text"=>"⌯ طلب الكود ❲ 💬 ❳. " ,"callback_data"=>"cv#$ex[3]"]],
[['text'=>"⌯ قناة تحديثات البوت☎ ❳  .",'url'=>"https://t.me/an2rakan"]]
]])
]);
}
...
["text"=>"⌯ طلب الكود ❲ 💬 ❳. " ,"callback_data"=>"nk#$ex[3]"]],
[['text'=>"⌯ قناة تحديثات البوت☎ ❳  .",'url'=>"https://t.me/an2rakan"]]
]])
]);
}
...
["text"=>"⌯ طلب الكود ❲ 💬 ❳. " ,"callback_data"=>"nf#$ex[3]"]],
[['text'=>"⌯ قناة تحديثات البوت☎ ❳  .",'url'=>"https://t.me/an2rakan"]]
]])
]);
}
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"⌯ تغيير الرقم ❲ ♻️ ❳. " ,"callback_data"=>"use"],
["text"=>"⌯ طلب الكود ❲ 💬 ❳. " ,"callback_data"=>"nq#$ex[3]"]],
[['text'=>"⌯ قناة تحديثات البوت☎ ❳  .",'url'=>"https://t.me/an2rakan"]]
]])
]);
}
...
##تمت ازالة الثغره من قبل راكان ALOUSH 
